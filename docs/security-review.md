...
| 項目 | ステータス | 対策 |
| --- | --- | --- |
| CSP（Content Security Policy） | 対応中 | Next.js の inline script / Tailwind inline style を考慮し Phase 6 で nonce ベースの CSP を導入予定。現時点は clickjack と HSTS で主要 XSS 経路はカバー |
